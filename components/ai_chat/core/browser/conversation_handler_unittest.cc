              ...
              [](EngineConsumer::GenerationDataCallback callback) {
                ...
                callback.Run(EngineConsumer::GenerationResultData(
                    mojom::ConversationEntryEvent::NewToolUseEvent(
                        mojom::ToolUseEvent::New(
                            "", "tool_id_1", "",
                            CreateWebSourcesOutput(1, "weather"), std::nullopt,
                            nullptr, true)),
                    std::nullopt));
              }),
          testing::WithArg<7>(
...
TEST_F(ConversationHandlerUnitTest,
  ...
  entry1->events->push_back(
      mojom::ConversationEntryEvent::NewToolUseEvent(mojom::ToolUseEvent::New(
          ...
          CreateWebSourcesOutput(2, "query one"), std::nullopt, nullptr,
          true)));
  ...
  entry2->events->push_back(
      mojom::ConversationEntryEvent::NewToolUseEvent(mojom::ToolUseEvent::New(
          ...
          CreateWebSourcesOutput(1, "query two"), std::nullopt, nullptr,
          true)));
...
TEST_F(ConversationHandlerUnitTest,
  ...
  early_assistant->events->push_back(
      mojom::ConversationEntryEvent::NewToolUseEvent(mojom::ToolUseEvent::New(
          ...
          CreateWebSourcesOutput(1, "old query"), std::nullopt, nullptr,
          true)));
...
TEST_F(ConversationHandlerUnitTest,
  ...
  entry->events->push_back(
      mojom::ConversationEntryEvent::NewToolUseEvent(mojom::ToolUseEvent::New(
          ...
          CreateWebSourcesOutput(1, ""), std::nullopt, nullptr, true)));
