...
GURL BraveStatsUpdaterParams::GetUpdateURL(
    ...
    std::unique_ptr<serp_metrics::AllProfilesSerpMetricsAggregator>
  ...
  if (serp_metrics_aggregator && ymd_ != last_check_ymd_) {
    ...
    update_url = net::AppendQueryParameter(
        ...
        base::NumberToString(
            serp_metrics_aggregator->GetBraveSearchCountForYesterday()));

    update_url = net::AppendQueryParameter(
        update_url, "googleSearch",
        base::NumberToString(
            serp_metrics_aggregator->GetGoogleSearchCountForYesterday()));

    update_url = net::AppendQueryParameter(
        update_url, "otherSearch",
        base::NumberToString(
            serp_metrics_aggregator->GetOtherSearchCountForYesterday()));
